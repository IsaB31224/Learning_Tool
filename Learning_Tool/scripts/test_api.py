...
questions = generate_context_questions(
    ...
    initial_reflection="When im with my friends i should be more noticing of their reactions to certain messages because it is only then i will see their real personality"
)
